    ...
    <div class="w-100">
        <div class="card my-4">
            <form action="" method="GET">
                <div
                    class="search-box shadow p-3 rounded-4 bg-white d-flex flex-column flex-md-row align-items-stretch gap-2">
                    <!-- Input Text -->
                    <div class="flex-grow-1 d-flex align-items-center border-bottom">
                        <i class="bi bi-search me-2 text-muted"></i>
                        <input type="text" name="keyword" name="search" class="form-control border-0 shadow-none"
                            placeholder="Cari dokumen...">
                    </div>

                    <!-- Filter Dropdowns -->
                    <div class="filter d-flex gap-3 flex-wrap justify-content-start justify-content-md-end">
            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href="/dokumen/detail/{{$item->id}}" class="btn btn-sm btn-primary">Detail</a>
                        </td>
                    </tr>
                @endforeach
