        ...
        <div id="pf1" class="pf w0 h0" data-page-no="1">
            <div class="pc pc1 w0 h0"><img class="bi x0 y0 w0 h0" alt=""
                ...
                > <div class="c x1 y0 w1 h1">
                    <div class="t m0 x2 h2 y1 ff1 fs0 fc0 sc0 ls0 ws0">KEMENTERIAN <span class="ls1">PENDIDIKAN,
                        </span>KEBUDAYAAN<span class="ls2">, </span></div>
                </div>
                ...
                <div class="t m0 x7 h4 y5 ff3 fs1 fc1 sc0 ls7 ws0">{{ $data['header']['jurusan'] }}<span
                        class="ls2"></span></div>
                <div class="t m0 x7 h4 y6 ff3 fs1 fc1 sc0 ls6 ws0">PROGRAM STUDI
                    {{ strtoupper($data['header']['program_studi']) }}<span class="ls2">
                    </span></div>
                <div class="t m0 x8 h5 y7 ff4 fs2 fc0 sc0 ls2 ws0">Jalan Raya Jambi - Ma. Bulian, KM.15, Mendalo Indah,
                    Jambi. Kode Pos 36361 </div>
                <div class="t m0 x9 h5 y8 ff4 fs2 fc0 sc0 ls8 ws0">email: <span class="ls2">fst@unja.ac.id, Laman:
                        http://fst.unja.ac.id </span></div>
                <div class="t m0 xa h5 y9 ff4 fs2 fc0 sc0 ls2 ws0"> </div>
                <div class="t m0 xb h6 ya ff5 fs2 fc2 sc0 ls2 ws0">BUKTI PENYERAHAN
                    {{ strtoupper($data['title']['nama']) }} </div>
                <div class="t m0 xc h5 yb ff4 fs2 fc2 sc0 ls2 ws0"> </div>
                <div class="t m0 xd h5 yc ff4 fs2 fc2 sc0 ls2 ws0">Telah diterima {{ $data['title']['nama'] }} saudara:
                </div>
                ...
                <div class="c x12 y10 w4 h8">
                    <div class="t m0 x11 h5 y11 ff4 fs2 fc2 sc0 ls2 ws0">{{ $data['form_data']['nomor_mahasiswa'] }}
                    </div>
                </div>
                ...
                <div class="c x12 y12 w4 h7">
                    <div class="t m0 x11 h5 y13 ff4 fs2 fc2 sc0 ls2 ws0">{{ $data['form_data']['prodi'] }} <span
                            class="fc3 sc0">
                ...
                <div class="t m0 xd h5 y29 ff4 fs2 fc2 sc0 ls2 ws0">Demikian bukti penyerahan ini dibuat untuk dapat
